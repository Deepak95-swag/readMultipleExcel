...
# Construct the Excel file path
    ...
    # Read the Excel file into a pandas DataFrame
    df = pd.read_excel(excelValuePath, sheet_name="Main")
    ...
    # Example function call to retrieve a specific value
    desired_Value = str(configHandle.getDesiredKeyAndColumn(key_value_dict, "P002", "Prod. Item Id."))
...
#     excelValuePath = configHandle.currentExcelPath(__file__)
    ...
    # Read the Excel file into a pandas DataFrame
    ReceiptEntry_AccountName_itemtablevalue_df = pd.read_excel(excelValuePath, sheet_name="ItemDetails")
    ...
    # Read the Excel file into a pandas DataFrame
    ReceiptEntry_CC_itemtablevalue_df = pd.read_excel(excelValuePath, sheet_name="InputLotDetails")
    ...
    # Read the Excel file into a pandas DataFrame
    ReceiptEntry_RP_itemtablevalue_df = pd.read_excel(excelValuePath, sheet_name="OutputLotDetails")
